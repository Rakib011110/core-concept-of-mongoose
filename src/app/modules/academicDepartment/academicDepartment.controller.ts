...
const createAcademicDepartmemt = catchAsynce(async (req, res) => {
  const result =
...
const getAllAcademicDepartments = catchAsynce(async (req, res) => {
  const result =
...
const getSingleAcademicDepartment = catchAsynce(async (req, res) => {
...
const updateAcademicDeartment = catchAsynce(async (req, res) => {
  const { departmentId } = req.params;
  const result =
